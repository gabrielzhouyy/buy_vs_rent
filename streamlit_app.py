...
with result_col1:
    ...
    st.markdown(f"If, it turns out you don't sell the house, your net position is  **${total_savings_invested + loan_amount - cumulative_interest_paid - hoa_paid - maintenance_paid:,.0f}**.")
    st.markdown("</div>", unsafe_allow_html=True)

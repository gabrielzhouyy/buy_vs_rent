...
total_rent_paid, average_monthly_rent, final_monthly_rent, monthly_rent = rent_calculator(monthly_rent, inflation, redemption_month,comparative_mthly_installment=monthly_payment)
